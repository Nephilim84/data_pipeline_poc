...
def get_logo():
    ...
    logo = html.Div(
        ...
        # ),
        html.Img(
            src='https://www.halcyonagri.com/wp-content/themes/vw-lawyer-attorney/images/halcyon-logo.png', height='48', width='144'
        ),
        style={"marginTop": "0"},
...
if __name__ == "__main__":
    ...
    app.run_server(host='0.0.0.0', debug=True, port=port, threaded=True)
